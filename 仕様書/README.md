...
- sympyを使って計算していたが、逆ポーランド記法のアルゴリズムの学習のため利用を中止した。
---
...
### 4.3 非機能要件
- 精度: 文字列19桁まで対応する
- セキュリティ: 独自の計算処理keisan.pyを使用する（悪意のあるコードの実行を避けるため、evalの使用を避けた）
...
## 15. セキュリティと注意点
- 入力に許可する文字を限定した。そのまま eval に流用しない
